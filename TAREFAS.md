...
Checklist de atividades para execução do trabalho final. Marque com `[x]` conforme concluído.

---

## Fase 1 — Setup e Infraestrutura

- [x] 1.1 Criar repositório público no GitHub
- [x] 1.2 Clonar repositório e configurar `.gitignore`
- [x] 1.3 Baixar dataset de pagamentos (JSON)
- [x] 1.4 Baixar dataset de pedidos (CSV)
- [x] 1.5 Analisar estrutura e schema dos datasets

## Fase 2 — Estrutura do Projeto e Empacotamento

- [x] 2.1 Definir estrutura de diretórios e pacotes
- [x] 2.2 Criar `pyproject.toml`
- [x] 2.3 Criar `requirements.txt`
- [x] 2.4 Criar `MANIFEST.in`
- [x] 2.5 Criar `main.py` (esqueleto)
- [x] 2.6 Configurar `pipenv` com `Pipfile` e `Pipfile.lock`
...
- [x] 6.1 Criar `README.md` com instruções de execução
